...
@interface GeoTakeController : UIViewController <MKMapViewDelegate, CLLocationManagerDelegate, MKReverseGeocoderDelegate, UITextViewDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIAlertViewDelegate> {
	@private
	// IBOutlets
	// Top Tab buttons
	...
	// For audio
	SpeakHereController		*audioController;
	...
	NSInteger				locationClickCount;
	NSInteger				addPlaceMarkCount;
	NSInteger				stopCount;
	UILabel					*precisionForMap;
	UILabel					*titleMapAccuracy;
...
@property (nonatomic, retain) UILabel		*precisionForMap;
@property (nonatomic, retain) UILabel		*titleMapAccuracy;
...
- (void)showLocateMe;
- (void)clearMapView;
- (void)showMapAccuracyLabel:(CLLocation*)location;
