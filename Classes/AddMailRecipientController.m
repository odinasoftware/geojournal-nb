...
- (void)viewDidLoad {
	...
	self.mailRecipientArray = [GeoDatabase sharedGeoDatabaseInstance].mailRecipientArray;
}
...
- (int)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
	...
	c = [self.mailRecipientArray count];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	else if (indexPath.row < [self.mailRecipientArray count]) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	int c = [self.mailRecipientArray count];
	if (indexPath.row < c) {
		MailRecipients *recipient = (MailRecipients*) [self.mailRecipientArray objectAtIndex:indexPath.row];
