...
- (void)session:(FBSession*)session didLogin:(FBUID)uid {
	...
	[(id)[[UIApplication sharedApplication] delegate] performSelectorOnMainThread:@selector(getFBUserName:) withObject:self waitUntilDone:NO];	
	[(id)[[UIApplication sharedApplication] delegate] performSelectorOnMainThread:@selector(getFBExtendedPermission:) withObject:nil waitUntilDone:NO];	
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	*/
	if (indexPath.section == MAIL_INDEX) {
		...
		else if ([GeoSession sharedGeoSessionInstance].fbUID) {
