...
{
	return @"Type a new mail recipient:";
}

- (NSString *)tableView:(UITableView *)tableView titleForFooterInSection:(NSInteger)section
{
	return @"Type a new mailto here.";
}
...
- (UITextField *)textInputField
{
	if (textInputField == nil)
	{
		...
		textInputField.keyboardType = UIKeyboardTypeEmailAddress;	// use the default type input method (entire keyboard)
